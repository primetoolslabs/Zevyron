...
if (-not (Test-IsAdmin)) {
    Write-Host "[Zevyron Debloat] This script must be run as Administrator." -ForegroundColor Red
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Zevyron Debloat v$version" 
    ...
    <Grid Margin="24">
        ...
        <Border Grid.Row="1" 
                ...
                Margin="0,0,0,20">
            <StackPanel>
                <RadioButton x:Name="RadioZevyron" 
                            Content="Zevyron Debloat (Choose which apps to remove) - Recommended" 
                            Margin="0,0,0,16" 
                            IsChecked="True"/>
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="Zevyron Debloat - Important Change" 
...
function Remove-SelectedApps {
    ...
    Write-Host "Starting Zevyron debloat..." -ForegroundColor Green
    ...
    Write-Host "Zevyron debloat completed!" -ForegroundColor Green
}

try {
    $script:appsWereRemoved = $false
    
    Write-Host "Starting Zevyron Debloat script..." -ForegroundColor Green
    ...
    elseif ($ScriptChoice -eq "custom") {
        if ($AppsToRemove.Count -gt 0) {
            Write-Host "Running Zevyron debloat to remove $($AppsToRemove.Count) apps..." -ForegroundColor Green
    ...
    if ($script:appsWereRemoved -and -not (Get-Process -Name "Zevyron" -ErrorAction SilentlyContinue)) {
        [xml]$xaml = @"
<Window 
    xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
    Title="Zevyron Debloat" 
    Height="200" 
    Width="480"
    WindowStartupLocation="CenterScreen"
    Background="#0c121f"
