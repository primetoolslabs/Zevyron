...
//       >
//         <motion.div
//           className="text-2xl font-medium mb-8 text-zevyron-text"
...
//         <div className="w-64 h-1 bg-zevyron-accent rounded-full ">
//           <motion.div
//             className="h-full bg-zevyron-primary"
...
//             <motion.div
//               key={i}
//               className={`w-3 h-3 rounded-full ${i === loadingStep ? "bg-zevyron-primary" : "bg-zevyron-accent"}`}
//               animate={{
