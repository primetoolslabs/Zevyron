  ...
  return (
    <>
      <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
        <div className="bg-zevyron-card border border-zevyron-border rounded-2xl p-4 shadow-2xl max-w-lg w-full mx-4 flex flex-col items-center text-center">
          <h1 className="text-3xl font-bold text-zevyron-text mb-4">
          ...
          <p className="text-zevyron-text-secondary mb-4 text-sm">
            ...
            <br />
            <br />
            <p className="text-zevyron-primary">
      ...
      <RootDiv>
        <div className="flex gap-4 flex-col mb-10 mr-4">
          ...
          {filteredUtilities.length === 0 && (
            <p className="text-zevyron-text-secondary flex text-center items-center justify-center gap-2">
                ...
                <Card className="p-4 flex items-center gap-4" key={util.name}>
                  ...
                  <div>
                    <div className="flex gap-3 items-center">
                      <h1>{util.name}</h1>{" "}
                      {util.command && (
                        <p className="text-xs text-zevyron-primary">
                          CMD:{" "}
                          <code className="bg-zevyron-border p-0.5 rounded-md">{util.command}</code>
                        </p>
                      )}
                    </div>
                    <p className="text-sm  text-zevyron-text-secondary">{util.description}</p>
                  </div>
                  <div className="flex justify-end ml-auto">
                    {util.type === "toggle" &&
                      (loadingStates[util.name] ? (
                        <div className="w-6 h-6 border-2 border-zevyron-border-secondary border-t-zevyron-primary rounded-full animate-spin" />
                      ) : (
                        <Toggle
