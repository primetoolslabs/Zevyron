# Zevyron 3.0.0-beta.15 Stable — Update Channel Bridge

Versão ponte para usuários do canal Stable.

- Continua sendo uma versão **Stable**, então instalações 2.29.x conseguem detectá-la normalmente.
...
- Permite que o usuário, após instalar 3.0.0-beta.15, escolha **Beta** e então receba `2.30.0-beta.x`.
