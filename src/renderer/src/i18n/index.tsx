...
const translations: Record<Language, Dictionary> = {
  ...
  "en-US": {
    ...
    "nav.dashboard":"Dashboard","nav.health":"PC Health","nav.gameMode":"Game Mode","nav.tweaks":"Tweaks","nav.debloat":"Debloat+","nav.utilities":"Utilities","nav.cleaner":"Cleaner","nav.restore":"Restore","nav.dns":"DNS Manager","nav.apps":"Apps","nav.settings":"Settings","nav.notifications":"Notifications","nav.reports":"Reports","nav.expert":"Expert Mode","nav.repair":"Repair Zevyron","nav.accessibility":"Accessibility","nav.about":"About Zevyron",
  ...
  "es-ES": {
    ...
    "nav.dashboard":"Inicio","nav.health":"Salud del PC","nav.gameMode":"Game Mode","nav.tweaks":"Optimizaciones","nav.debloat":"Debloat+","nav.utilities":"Utilidades","nav.cleaner":"Limpieza","nav.restore":"Restauración","nav.dns":"Gestor DNS","nav.apps":"Aplicaciones","nav.settings":"Configuración","nav.notifications":"Notificaciones","nav.reports":"Informes","nav.expert":"Modo Experto","nav.repair":"Reparar Zevyron","nav.accessibility":"Accesibilidad","nav.about":"Acerca de Zevyron",
