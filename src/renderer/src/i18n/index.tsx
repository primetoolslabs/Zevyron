...
const translations: Record<Language, Dictionary> = {
  "pt-BR": {
    ...
    "nav.dashboard":"Início","nav.home":"Início","nav.recovery":"Recuperação","nav.startup":"Inicialização","nav.networkCenter":"Network Center","nav.hardwareMonitor":"Hardware","nav.clean":"Limpeza","nav.backup":"Restaurar","nav.health":"Saúde do PC","nav.gameMode":"Game Mode","nav.tweaks":"Otimizações","nav.debloat":"Debloat+","nav.utilities":"Utilitários","nav.cleaner":"Limpeza","nav.restore":"Restauração","nav.dns":"Gerenciador DNS","nav.apps":"Aplicativos","nav.settings":"Configurações","nav.notifications":"Notificações","nav.reports":"Relatórios","nav.expert":"Modo Especialista","nav.repair":"Reparar Zevyron","nav.accessibility":"Acessibilidade","nav.about":"Sobre o Zevyron",
  ...
  "en-US": {
    ...
    "nav.dashboard":"Dashboard","nav.home":"Home","nav.recovery":"Recovery","nav.startup":"Startup","nav.networkCenter":"Network Center","nav.hardwareMonitor":"Hardware","nav.clean":"Cleanup","nav.backup":"Restore","nav.health":"PC Health","nav.gameMode":"Game Mode","nav.tweaks":"Tweaks","nav.debloat":"Debloat+","nav.utilities":"Utilities","nav.cleaner":"Cleaner","nav.restore":"Restore","nav.dns":"DNS Manager","nav.apps":"Apps","nav.settings":"Settings","nav.notifications":"Notifications","nav.reports":"Reports","nav.expert":"Expert Mode","nav.repair":"Repair Zevyron","nav.accessibility":"Accessibility","nav.about":"About Zevyron",
  ...
  "es-ES": {
    ...
    "nav.dashboard":"Inicio","nav.home":"Inicio","nav.recovery":"Recuperación","nav.startup":"Inicio automático","nav.networkCenter":"Centro de Red","nav.hardwareMonitor":"Hardware","nav.clean":"Limpieza","nav.backup":"Restaurar","nav.health":"Salud del PC","nav.gameMode":"Game Mode","nav.tweaks":"Optimizaciones","nav.debloat":"Debloat+","nav.utilities":"Utilidades","nav.cleaner":"Limpieza","nav.restore":"Restauración","nav.dns":"Gestor DNS","nav.apps":"Aplicaciones","nav.settings":"Configuración","nav.notifications":"Notificaciones","nav.reports":"Informes","nav.expert":"Modo Experto","nav.repair":"Reparar Zevyron","nav.accessibility":"Accesibilidad","nav.about":"Acerca de Zevyron",
