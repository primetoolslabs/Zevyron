...
const translations: Record<Language, Dictionary> = {
  "pt-BR": {
    ...
    "nav.dashboard":"Início","nav.gameMode":"Game Mode","nav.tweaks":"Otimizações","nav.debloat":"Debloat+","nav.utilities":"Utilitários","nav.cleaner":"Limpeza","nav.restore":"Restauração","nav.dns":"Gerenciador DNS","nav.apps":"Aplicativos","nav.settings":"Configurações","nav.about":"Sobre o Zevyron",
  ...
  "en-US": {
    ...
    "nav.dashboard":"Dashboard","nav.gameMode":"Game Mode","nav.tweaks":"Tweaks","nav.debloat":"Debloat+","nav.utilities":"Utilities","nav.cleaner":"Cleaner","nav.restore":"Restore","nav.dns":"DNS Manager","nav.apps":"Apps","nav.settings":"Settings","nav.about":"About Zevyron",
  ...
  "es-ES": {
    ...
    "nav.dashboard":"Inicio","nav.gameMode":"Game Mode","nav.tweaks":"Optimizaciones","nav.debloat":"Debloat+","nav.utilities":"Utilidades","nav.cleaner":"Limpieza","nav.restore":"Restauración","nav.dns":"Gestor DNS","nav.apps":"Aplicaciones","nav.settings":"Configuración","nav.about":"Acerca de Zevyron",
