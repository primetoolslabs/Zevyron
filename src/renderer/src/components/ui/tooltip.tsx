...
const Tooltip = ({
  ...
  return (
    ...
    >
      {children}
      <div
        className={`absolute z-50 pointer-events-none px-2 py-1 text-xs font-medium bg-zevyron-card text-zevyron-text rounded-md shadow-lg border border-zevyron-border whitespace-nowrap transition-all duration-150 ease-out`}
        style={{
