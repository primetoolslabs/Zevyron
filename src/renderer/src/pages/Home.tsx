      ...
      <div className="max-w-[1680px] mx-auto p-4 lg:p-5 space-y-3 bg-[radial-gradient(circle_at_70%_-10%,rgba(0,87,255,.08),transparent_34%)]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_1.28fr_1.08fr] gap-3">
          <section className="rounded-xl border border-zevyron-border bg-[#071221]/95 p-4">
            ...
            <button onClick={()=>navigate('/health')} className="mt-3 w-full py-2 rounded-lg border border-[#057dcb] text-[#15adff] text-sm hover:bg-[#08243d]">DETALHES DO SCORE</button>
          </section>
          ...
          <section className="relative overflow-hidden rounded-xl border border-[#16466f] bg-[radial-gradient(circle_at_50%_10%,rgba(0,108,255,.22),transparent_42%),#050d19] p-5 flex items-center gap-5">
            ...
            <div className="flex-1"><div className="text-xl font-semibold">ZEVYRON BOOST</div><p className="text-xs text-zevyron-text-secondary mt-1 mb-4">Encontre e aplique as melhores otimizações para máximo desempenho.</p><button onClick={()=>navigate('/health')} className="w-full py-3 rounded-lg border border-[#00aaff] bg-[#006dff24] text-[#19b7ff] text-xl shadow-[inset_0_0_24px_rgba(0,109,255,.16),0_0_14px_rgba(0,109,255,.14)]"><Zap className="inline mr-2"/>OTIMIZAR AGORA</button><button onClick={()=>navigate('/health')} className="w-full mt-2 text-xs text-[#17b4ff]"><Search size={13} className="inline mr-2"/>Análise rápida</button></div>
          </section>
